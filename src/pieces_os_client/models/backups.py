...
class Backups(BaseModel):
    """
    This is a plural model of many Cloud Backups.  # noqa: E501
    """
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    iterable: conlist(Backup) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Backups:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Backups:
        """Create an instance of Backups from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Backups.parse_obj(obj)

        _obj = Backups.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "iterable": [Backup.from_dict(_item) for _item in obj.get("iterable")] if obj.get("iterable") is not None else None,
