...
class Website(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "id", "assets", "url", "name", "created", "updated", "deleted", "mechanisms", "interactions", "persons", "conversations", "score", "summaries", "messages"]
