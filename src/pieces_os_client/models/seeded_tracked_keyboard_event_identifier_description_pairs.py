...
class SeededTrackedKeyboardEventIdentifierDescriptionPairs(BaseModel):
    ...
    def assets_list_refreshed_validate_enum(cls, value):
        ...
        if value not in ('UNKNOWN', 'the_assets_list_was_refreshed_through_a_keyboard_shortcut',):
            raise ValueError("must be one of enum values ('UNKNOWN', 'the_assets_list_was_refreshed_through_a_keyboard_shortcut')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeededTrackedKeyboardEventIdentifierDescriptionPairs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeededTrackedKeyboardEventIdentifierDescriptionPairs:
        """Create an instance of SeededTrackedKeyboardEventIdentifierDescriptionPairs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SeededTrackedKeyboardEventIdentifierDescriptionPairs.parse_obj(obj)

        _obj = SeededTrackedKeyboardEventIdentifierDescriptionPairs.parse_obj({
