...
class QGPTStreamedOutputExtractedTextualMaterials(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["message", "schema", "workstream"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "message": TextuallyExtractedMaterials.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "schema": EmbeddedModelSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
            "workstream": TextuallyExtractedMaterials.from_dict(obj["workstream"]) if obj.get("workstream") is not None else None
        })
        return _obj
