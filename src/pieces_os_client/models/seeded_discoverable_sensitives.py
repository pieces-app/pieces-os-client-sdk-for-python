...
class SeededDiscoverableSensitives(BaseModel):
    ...
    iterable: conlist(SeededDiscoverableSensitive) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeededDiscoverableSensitives:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeededDiscoverableSensitives:
        """Create an instance of SeededDiscoverableSensitives from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SeededDiscoverableSensitives.parse_obj(obj)

        _obj = SeededDiscoverableSensitives.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "iterable": [SeededDiscoverableSensitive.from_dict(_item) for _item in obj.get("iterable")] if obj.get("iterable") is not None else None,
