...
class SearchedWorkstreamPatternEngineSourceWindow(BaseModel):
    ...
    """ # noqa: E501
    exact: StrictBool
    identifier: StrictStr = Field(description="This is the uuid of the source.")
    ...
    __properties: ClassVar[List[str]] = ["exact", "identifier", "schema", "similarity", "temporal", "workstreamPatternEngineSourceWindow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workstreamPatternEngineSourceWindow": WorkstreamPatternEngineSourceWindow.from_dict(obj["workstreamPatternEngineSourceWindow"]) if obj.get("workstreamPatternEngineSourceWindow") is not None else None
        })
        return _obj
