...
class PaddleCheckoutCompletedEvent(BaseModel):
    ...
    """ # noqa: E501
    data: PaddleCheckoutLoadedEventData
    name: StrictStr
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    __properties: ClassVar[List[str]] = ["data", "name", "schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PaddleCheckoutLoadedEventData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "name": obj.get("name"),
