...
class PaddleCheckoutCompletedEvent(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaddleCheckoutCompletedEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaddleCheckoutCompletedEvent:
        """Create an instance of PaddleCheckoutCompletedEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaddleCheckoutCompletedEvent.parse_obj(obj)

        _obj = PaddleCheckoutCompletedEvent.parse_obj({
