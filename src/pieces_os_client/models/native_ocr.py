...
class NativeOCR(BaseModel):
    ...
    is_cached: StrictBool = Field(description="Indicates whether the workflow mapping is cached.", alias="isCached")
    ...
    __properties: ClassVar[List[str]] = ["schema", "ocrText", "ocrTextHash", "appTitle", "windowTitle", "browserUrl", "isMerged", "isCached", "embeddingModelUniqueName"]
