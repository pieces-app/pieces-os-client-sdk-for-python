...
class TLPCodeFragmentSuggestedReuse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TLPCodeFragmentSuggestedReuse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TLPCodeFragmentSuggestedReuse:
        """Create an instance of TLPCodeFragmentSuggestedReuse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TLPCodeFragmentSuggestedReuse.parse_obj(obj)

        _obj = TLPCodeFragmentSuggestedReuse.parse_obj({
