...
class Auth0UserBetaStatus(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Auth0UserBetaStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Auth0UserBetaStatus:
        """Create an instance of Auth0UserBetaStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Auth0UserBetaStatus.parse_obj(obj)

        _obj = Auth0UserBetaStatus.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "vision": AnonymousTemporalRange.from_dict(obj.get("vision")) if obj.get("vision") is not None else None
        })
        return _obj
