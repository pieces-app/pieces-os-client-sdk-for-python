...
class SearchedAnnotation(BaseModel):
    ...
    identifier: StrictStr = Field(description="This is the uuid of the annotation.")
    __properties: ClassVar[List[str]] = ["schema", "annotation", "exact", "similarity", "temporal", "identifier"]
