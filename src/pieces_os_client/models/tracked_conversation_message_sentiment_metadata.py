...
class TrackedConversationMessageSentimentMetadata(BaseModel):
    """
    ...
    __properties = ["schema", "message", "sentiment"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrackedConversationMessageSentimentMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrackedConversationMessageSentimentMetadata:
        """Create an instance of TrackedConversationMessageSentimentMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrackedConversationMessageSentimentMetadata.parse_obj(obj)

        _obj = TrackedConversationMessageSentimentMetadata.parse_obj({
