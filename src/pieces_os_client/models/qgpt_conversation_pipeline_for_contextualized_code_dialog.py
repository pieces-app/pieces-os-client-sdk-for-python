...
class QGPTConversationPipelineForContextualizedCodeDialog(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QGPTConversationPipelineForContextualizedCodeDialog:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QGPTConversationPipelineForContextualizedCodeDialog:
        """Create an instance of QGPTConversationPipelineForContextualizedCodeDialog from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QGPTConversationPipelineForContextualizedCodeDialog.parse_obj(obj)

        _obj = QGPTConversationPipelineForContextualizedCodeDialog.parse_obj({
