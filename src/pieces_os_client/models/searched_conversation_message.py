...
class SearchedConversationMessage(BaseModel):
    ...
    identifier: StrictStr = Field(description="This is the uuid of the ConversationMessage.")
    __properties: ClassVar[List[str]] = ["schema", "message", "exact", "similarity", "temporal", "identifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message": ConversationMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
            "exact": obj.get("exact"),
