...
class TLPDirectedDiscoveryFilters(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TLPDirectedDiscoveryFilters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TLPDirectedDiscoveryFilters:
        """Create an instance of TLPDirectedDiscoveryFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TLPDirectedDiscoveryFilters.parse_obj(obj)

        _obj = TLPDirectedDiscoveryFilters.parse_obj({
            "iterable": [TLPDirectedDiscoveryFilter.from_dict(_item) for _item in obj.get("iterable")] if obj.get("iterable") is not None else None
        })
        return _obj
