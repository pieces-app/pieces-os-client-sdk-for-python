...
class WorkstreamSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "id", "score", "created", "updated", "events", "name", "annotations", "ranges", "model", "websites", "anchors", "assets", "conversations", "persons", "applications", "tags", "workstreamSummariesVector", "sources", "processing", "favorited"]
