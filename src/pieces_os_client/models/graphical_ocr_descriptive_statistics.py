...
class GraphicalOCRDescriptiveStatistics(BaseModel):
    ...
    duration: StrictStr
    __properties: ClassVar[List[str]] = ["schema", "asset", "user", "model", "created", "os", "confidence", "duration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "os": obj.get("os"),
            "confidence": GraphicalOCRDescriptiveStatisticsConfidence.from_dict(obj["confidence"]) if obj.get("confidence") is not None else None,
