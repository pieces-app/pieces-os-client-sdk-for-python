...
class HasFeatureAccessDeniedWorkstreamPatternEngineWebsiteContext(BaseModel):
    """
    Context for checking if a specific website is denied.
    """ # noqa: E501
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    website: StrictStr = Field(description="The website URL to check.")
    __properties: ClassVar[List[str]] = ["schema", "website"]
