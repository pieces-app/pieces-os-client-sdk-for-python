...
class FoundryStatus(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "installation": FoundryDeployment.from_dict(obj["installation"]) if obj.get("installation") is not None else None,
            "installing": FoundryDeployment.from_dict(obj["installing"]) if obj.get("installing") is not None else None,
            "recommendation": FoundryRecommendation.from_dict(obj["recommendation"]) if obj.get("recommendation") is not None else None,
            "schema": EmbeddedModelSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
            "updateRequired": FoundryDeployment.from_dict(obj["updateRequired"]) if obj.get("updateRequired") is not None else None,
            "updating": FoundryDeployment.from_dict(obj["updating"]) if obj.get("updating") is not None else None
        })
        return _obj
