...
class LanguageServerProtocolLocationRangePosition(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguageServerProtocolLocationRangePosition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LanguageServerProtocolLocationRangePosition:
