...
class ModelContextProtocolSchemaVersion(BaseModel):
    ...
    """ # noqa: E501
    entry_endpoint: StrictStr = Field(description="this is the endpoint that the use should use to configure the server.")
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    version: StrictStr
    __properties: ClassVar[List[str]] = ["entry_endpoint", "schema", "version"]
