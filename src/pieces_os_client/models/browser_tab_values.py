...
class BrowserTabValues(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrowserTabValues:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrowserTabValues:
        """Create an instance of BrowserTabValues from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrowserTabValues.parse_obj(obj)

        _obj = BrowserTabValues.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "iterable": [BrowserTabValue.from_dict(_item) for _item in obj.get("iterable")] if obj.get("iterable") is not None else None
        })
        return _obj
