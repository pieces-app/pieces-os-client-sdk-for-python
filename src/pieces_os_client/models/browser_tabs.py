...
class BrowserTabs(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [BrowserTab.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None
        })
        return _obj

from pieces_os_client.models.browser_tab import BrowserTab
# TODO: Rewrite to not use raise_errors
BrowserTabs.model_rebuild(raise_errors=False)
