...
class WorkstreamEvents(BaseModel):
    """
    This is a collection of many Shadow Activity events.  # noqa: E501
    """
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    iterable: conlist(WorkstreamEvent) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkstreamEvents:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkstreamEvents:
        """Create an instance of WorkstreamEvents from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkstreamEvents.parse_obj(obj)

        _obj = WorkstreamEvents.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "iterable": [WorkstreamEvent.from_dict(_item) for _item in obj.get("iterable")] if obj.get("iterable") is not None else None,
