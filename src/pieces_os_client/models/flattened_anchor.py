...
class FlattenedAnchor(BaseModel):
    ...
    __properties = ["schema", "id", "type", "watch", "points", "created", "updated", "deleted", "assets", "name", "annotations", "conversations", "score", "summaries", "persons", "messages", "workstream_events", "sources", "tags"]
