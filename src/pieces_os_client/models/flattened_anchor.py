...
class FlattenedAnchor(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "id", "type", "watch", "points", "created", "updated", "deleted", "assets", "name", "annotations", "conversations", "score", "summaries", "persons", "messages"]
