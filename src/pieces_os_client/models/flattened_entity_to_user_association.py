...
class FlattenedEntityToUserAssociation(BaseModel):
    """
    ...
    user: StrictStr = Field(description="User UUID")
    __properties: ClassVar[List[str]] = ["created", "entity", "id", "schema", "score", "updated", "user"]
