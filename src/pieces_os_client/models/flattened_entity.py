...
class FlattenedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["configuration", "created", "deleted", "id", "name", "org_identifier", "schema", "subscriptions", "team_identifier", "type", "updated", "users"]
...
FlattenedEntity.model_rebuild(raise_errors=False)
