...
class FlattenedEntityToSubscriptionAssociation(BaseModel):
    """
    ...
    entity: StrictStr = Field(description="Entity UUID")
    id: StrictStr
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    score: Optional[Score] = None
    subscription: StrictStr = Field(description="Subscription UUID")
    updated: GroupedTimestamp
    __properties: ClassVar[List[str]] = ["created", "entity", "id", "schema", "score", "subscription", "updated"]
