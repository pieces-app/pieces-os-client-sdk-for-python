...
class SearchedConversations(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [SearchedConversation.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None
        })
        return _obj
