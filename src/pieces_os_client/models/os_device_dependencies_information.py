...
class OSDeviceDependenciesInformation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OSDeviceDependenciesInformation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OSDeviceDependenciesInformation:
        """Create an instance of OSDeviceDependenciesInformation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OSDeviceDependenciesInformation.parse_obj(obj)

        _obj = OSDeviceDependenciesInformation.parse_obj({
