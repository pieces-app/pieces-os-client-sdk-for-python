...
class SearchedWorkstreamPatternEngineVisionEvent(BaseModel):
    ...
    identifier: StrictStr = Field(description="This is the uuid of the event.")
    __properties: ClassVar[List[str]] = ["schema", "event", "exact", "similarity", "temporal", "application", "identifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event": WorkstreamPatternEngineVisionEvent.from_dict(obj["event"]) if obj.get("event") is not None else None,
            "exact": obj.get("exact"),
