...
class FlattenedWebsite(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "id", "assets", "name", "url", "created", "updated", "deleted", "mechanisms", "interactions", "persons", "conversations", "score", "summaries", "messages"]
