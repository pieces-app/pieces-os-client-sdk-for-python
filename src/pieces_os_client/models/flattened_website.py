...
class FlattenedWebsite(BaseModel):
    ...
    __properties = ["schema", "id", "assets", "name", "url", "created", "updated", "deleted", "mechanisms", "interactions", "persons", "conversations", "score", "summaries", "messages", "annotations", "workstream_events", "sources", "source_windows", "tags"]
