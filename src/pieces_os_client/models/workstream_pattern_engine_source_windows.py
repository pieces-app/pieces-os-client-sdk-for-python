...
class WorkstreamPatternEngineSourceWindows(BaseModel):
    ...
    iterable: List[WorkstreamPatternEngineSourceWindow] = Field(description="This is the iterable of the source windows")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [WorkstreamPatternEngineSourceWindow.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
