...
class PaddleCheckoutCustomer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "business", "email", "id", "schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": PaddleCheckoutAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "business": PaddleCheckoutBusiness.from_dict(obj["business"]) if obj.get("business") is not None else None,
            "email": obj.get("email"),
            "id": obj.get("id"),
