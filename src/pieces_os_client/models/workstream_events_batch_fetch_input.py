...
class WorkstreamEventsBatchFetchInput(BaseModel):
    """
    ...
    workstream_events: Optional[FlattenedWorkstreamEvents] = Field(default=None, alias="workstreamEvents")
    __properties: ClassVar[List[str]] = ["schema", "workstreamEvents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workstreamEvents": FlattenedWorkstreamEvents.from_dict(obj["workstreamEvents"]) if obj.get("workstreamEvents") is not None else None
        })
        return _obj
