...
from pieces_os_client.models.foundry_deployment_status_enum import FoundryDeploymentStatusEnum
...
class FoundryDeployment(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FoundryDeployment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FoundryDeployment:
        """Create an instance of FoundryDeployment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FoundryDeployment.parse_obj(obj)

        _obj = FoundryDeployment.parse_obj({
