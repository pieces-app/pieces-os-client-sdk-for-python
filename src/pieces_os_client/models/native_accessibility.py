...
class NativeAccessibility(BaseModel):
    """
    This is a specific model to encapsulate NativeAccessibility data from the LTM(used within the WorkstreamEvent.  # noqa: E501
    """
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    accessibility_text: StrictStr = Field(default=..., alias="accessibilityText", description="The accessibility text extracted.")
    ...
    __properties = ["schema", "accessibilityText", "appTitle", "windowTitle", "browserUrl", "isMerged", "isCached"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NativeAccessibility:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NativeAccessibility:
        """Create an instance of NativeAccessibility from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NativeAccessibility.parse_obj(obj)

        _obj = NativeAccessibility.parse_obj({
