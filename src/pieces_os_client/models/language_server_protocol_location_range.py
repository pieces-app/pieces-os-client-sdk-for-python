...
class LanguageServerProtocolLocationRange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguageServerProtocolLocationRange:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic.v1 by calling `to_dict()` of start
        if self.start:
            _dict['start'] = self.start.to_dict()
        # override the default output from pydantic.v1 by calling `to_dict()` of end
        if self.end:
            _dict['end'] = self.end.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> LanguageServerProtocolLocationRange:
