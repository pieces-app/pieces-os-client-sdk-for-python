...
class LanguageServerProtocol(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "diagnostics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "diagnostics": LanguageServerProtocolDiagnostics.from_dict(obj["diagnostics"]) if obj.get("diagnostics") is not None else None
        })
        return _obj
