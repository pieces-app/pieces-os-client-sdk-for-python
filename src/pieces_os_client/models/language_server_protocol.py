...
class LanguageServerProtocol(BaseModel):
    """
    TODO  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguageServerProtocol:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic.v1 by calling `to_dict()` of diagnostics
        if self.diagnostics:
            _dict['diagnostics'] = self.diagnostics.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> LanguageServerProtocol:
