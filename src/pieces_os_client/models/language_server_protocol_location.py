...
class LanguageServerProtocolLocation(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguageServerProtocolLocation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LanguageServerProtocolLocation:
