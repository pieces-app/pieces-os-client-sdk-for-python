...
class SeededModel(BaseModel):
    ...
    __properties = ["bytes", "capabilities", "cloud", "cpu", "created", "custom", "description", "downloaded", "foundation", "maxTokens", "name", "parameters", "provider", "quantization", "ram", "schema", "type", "unique", "usage", "version"]
