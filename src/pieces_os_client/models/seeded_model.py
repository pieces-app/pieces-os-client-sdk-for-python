...
class SeededModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bytes", "capabilities", "cloud", "cpu", "created", "custom", "denied", "description", "downloaded", "foundation", "maxTokens", "name", "organization", "parameters", "provider", "quantization", "ram", "schema", "type", "unique", "usage", "version"]
