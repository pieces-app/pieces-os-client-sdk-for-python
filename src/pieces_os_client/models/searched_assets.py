...
class SearchedAssets(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "iterable", "suggested", "exact"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [SearchedAsset.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
