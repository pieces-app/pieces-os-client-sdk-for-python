...
class TLPCodeFileAnalytics(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TLPCodeFileAnalytics:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TLPCodeFileAnalytics:
        """Create an instance of TLPCodeFileAnalytics from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TLPCodeFileAnalytics.parse_obj(obj)

        _obj = TLPCodeFileAnalytics.parse_obj({
