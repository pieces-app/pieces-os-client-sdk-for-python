...
class WorkstreamEventTriggerContextIDE(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["modules", "name", "schema", "tabs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "modules": ProjectModules.from_dict(obj["modules"]) if obj.get("modules") is not None else None,
            "name": obj.get("name"),
            "schema": EmbeddedModelSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
            "tabs": IDETabs.from_dict(obj["tabs"]) if obj.get("tabs") is not None else None
        })
        return _obj
...
WorkstreamEventTriggerContextIDE.model_rebuild(raise_errors=False)
