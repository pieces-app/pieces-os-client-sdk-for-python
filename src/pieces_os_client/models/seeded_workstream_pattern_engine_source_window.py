...
class SeededWorkstreamPatternEngineSourceWindow(BaseModel):
    """
    This is the seeded source window for the workstream pattern engine  # noqa: E501
    """
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    name: StrictStr = Field(default=..., description="The name of the seeded source window")
    workstream_events: Optional[FlattenedWorkstreamEvents] = None
    __properties = ["schema", "name", "workstream_events"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeededWorkstreamPatternEngineSourceWindow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeededWorkstreamPatternEngineSourceWindow:
        """Create an instance of SeededWorkstreamPatternEngineSourceWindow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SeededWorkstreamPatternEngineSourceWindow.parse_obj(obj)

        _obj = SeededWorkstreamPatternEngineSourceWindow.parse_obj({
