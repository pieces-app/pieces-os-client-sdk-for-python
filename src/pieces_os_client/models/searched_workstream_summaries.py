...
class SearchedWorkstreamSummaries(BaseModel):
    ...
    """ # noqa: E501
    iterable: List[SearchedWorkstreamSummary]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iterable": [SearchedWorkstreamSummary.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
