...
class WorkstreamSummariesBatchInput(BaseModel):
    """
    ...
    workstream_summaries: Optional[FlattenedWorkstreamSummaries] = Field(default=None, alias="workstreamSummaries")
    __properties: ClassVar[List[str]] = ["schema", "workstreamSummaries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workstreamSummaries": FlattenedWorkstreamSummaries.from_dict(obj["workstreamSummaries"]) if obj.get("workstreamSummaries") is not None else None
        })
        return _obj
