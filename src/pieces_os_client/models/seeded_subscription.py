...
from pieces_os_client.models.subscription_term_enum import SubscriptionTermEnum

class SeededSubscription(BaseModel):
    """
    A minimal, creation-focused model for creating a Subscription. Uses string IDs for references.  # noqa: E501
    """
    ...
    __properties = ["schema", "user", "next_billing_date", "paused", "cancelled", "created", "active", "term", "quantity", "subscription_id", "product_id", "name", "price_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeededSubscription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeededSubscription:
        """Create an instance of SeededSubscription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SeededSubscription.parse_obj(obj)

        _obj = SeededSubscription.parse_obj({
