...
class TLPCodeProcessing(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "fragment", "file", "directory", "repository"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fragment": TLPCodeSnippetAnalytics.from_dict(obj["fragment"]) if obj.get("fragment") is not None else None,
            "file": TLPCodeFileAnalytics.from_dict(obj["file"]) if obj.get("file") is not None else None,
            "directory": TLPCodeDirectoryAnalytics.from_dict(obj["directory"]) if obj.get("directory") is not None else None,
            "repository": TLPCodeRepositoryAnalytics.from_dict(obj["repository"]) if obj.get("repository") is not None else None
        })
        return _obj
