...
class PaddleCheckoutLoadedEvent(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaddleCheckoutLoadedEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaddleCheckoutLoadedEvent:
        """Create an instance of PaddleCheckoutLoadedEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaddleCheckoutLoadedEvent.parse_obj(obj)

        _obj = PaddleCheckoutLoadedEvent.parse_obj({
