...
class SearchedHint(BaseModel):
    ...
    identifier: StrictStr = Field(description="This is the uuid of the hint.")
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    similarity: Union[StrictFloat, StrictInt]
    temporal: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["exact", "hint", "identifier", "schema", "similarity", "temporal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exact": obj.get("exact"),
            "hint": Hint.from_dict(obj["hint"]) if obj.get("hint") is not None else None,
