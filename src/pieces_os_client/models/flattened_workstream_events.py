...
class FlattenedWorkstreamEvents(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FlattenedWorkstreamEvents:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FlattenedWorkstreamEvents:
        """Create an instance of FlattenedWorkstreamEvents from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FlattenedWorkstreamEvents.parse_obj(obj)

        _obj = FlattenedWorkstreamEvents.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "iterable": [ReferencedWorkstreamEvent.from_dict(_item) for _item in obj.get("iterable")] if obj.get("iterable") is not None else None,
...
FlattenedWorkstreamEvents.update_forward_refs()
