...
class FlattenedConversationMessages(BaseModel):
    ...
    iterable: List[ReferencedConversationMessage]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedConversationMessage.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedConversationMessages.model_rebuild(raise_errors=False)
