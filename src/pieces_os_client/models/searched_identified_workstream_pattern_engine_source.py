...
class SearchedIdentifiedWorkstreamPatternEngineSource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["exact", "identifier", "schema", "similarity", "temporal", "workstreamPatternEngineSource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workstreamPatternEngineSource": IdentifiedWorkstreamPatternEngineSource.from_dict(obj["workstreamPatternEngineSource"]) if obj.get("workstreamPatternEngineSource") is not None else None
        })
        return _obj
