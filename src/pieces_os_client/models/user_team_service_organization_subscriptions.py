...
class UserTeamServiceOrganizationSubscriptions(BaseModel):
    """
    This is the descope user subscriptions
    """ # noqa: E501
    iterable: List[UserTeamServiceOrganizationSubscription] = Field(description="This is the iterable of the descope user subscriptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iterable": [UserTeamServiceOrganizationSubscription.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
