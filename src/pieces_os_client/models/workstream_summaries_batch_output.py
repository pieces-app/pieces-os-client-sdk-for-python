...
class WorkstreamSummariesBatchOutput(BaseModel):
    """
    ...
    """ # noqa: E501
    not_found: Optional[List[StrictStr]] = Field(default=None, description="List of UUIDs that were requested but not found", alias="notFound")
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    workstream_summaries: WorkstreamSummaries = Field(alias="workstreamSummaries")
    __properties: ClassVar[List[str]] = ["notFound", "schema", "workstreamSummaries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.workstream_summaries:
            _dict['workstreamSummaries'] = self.workstream_summaries.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workstreamSummaries": WorkstreamSummaries.from_dict(obj["workstreamSummaries"]) if obj.get("workstreamSummaries") is not None else None
        })
        return _obj
