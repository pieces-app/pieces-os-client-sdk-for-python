...
class WorkstreamPatternEngineVisionEventTextualValue(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkstreamPatternEngineVisionEventTextualValue:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkstreamPatternEngineVisionEventTextualValue:
