...
class ReferencedEntityToSubscriptionAssociation(BaseModel):
    """
    A minimal reference to an EntityToSubscriptionAssociation with optional flattened data.
    """ # noqa: E501
    id: StrictStr = Field(description="The UUID of the association")
    reference: Optional[FlattenedEntityToSubscriptionAssociation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "reference": FlattenedEntityToSubscriptionAssociation.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
