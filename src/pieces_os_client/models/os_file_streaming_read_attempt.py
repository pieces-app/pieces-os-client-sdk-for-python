...
class OSFileStreamingReadAttempt(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OSFileStreamingReadAttempt:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OSFileStreamingReadAttempt:
