...
class FlattenedWorkstreamSummaries(BaseModel):
    ...
    iterable: List[ReferencedWorkstreamSummary]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedWorkstreamSummary.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedWorkstreamSummaries.model_rebuild(raise_errors=False)
