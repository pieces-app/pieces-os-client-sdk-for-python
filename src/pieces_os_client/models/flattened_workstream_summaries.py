...
class FlattenedWorkstreamSummaries(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FlattenedWorkstreamSummaries:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FlattenedWorkstreamSummaries:
        """Create an instance of FlattenedWorkstreamSummaries from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FlattenedWorkstreamSummaries.parse_obj(obj)

        _obj = FlattenedWorkstreamSummaries.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "iterable": [ReferencedWorkstreamSummary.from_dict(_item) for _item in obj.get("iterable")] if obj.get("iterable") is not None else None,
...
FlattenedWorkstreamSummaries.update_forward_refs()
