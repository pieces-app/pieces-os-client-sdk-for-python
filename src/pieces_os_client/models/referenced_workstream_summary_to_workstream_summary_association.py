...
class ReferencedWorkstreamSummaryToWorkstreamSummaryAssociation(BaseModel):
    """
    this is a referenced minimal version of a WorkstreamSummaryToWorkstreamSummaryAssociation typically just our uuid.
    """ # noqa: E501
    id: StrictStr
    reference: Optional[FlattenedWorkstreamSummaryToWorkstreamSummaryAssociation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "reference": FlattenedWorkstreamSummaryToWorkstreamSummaryAssociation.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
