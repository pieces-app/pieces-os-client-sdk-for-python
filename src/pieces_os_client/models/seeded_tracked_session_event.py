...
class SeededTrackedSessionEvent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeededTrackedSessionEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeededTrackedSessionEvent:
        """Create an instance of SeededTrackedSessionEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SeededTrackedSessionEvent.parse_obj(obj)

        _obj = SeededTrackedSessionEvent.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "identifier_description_pair": TrackedSessionEventIdentifierDescriptionPairs.from_dict(obj.get("identifier_description_pair")) if obj.get("identifier_description_pair") is not None else None
        })
        return _obj
