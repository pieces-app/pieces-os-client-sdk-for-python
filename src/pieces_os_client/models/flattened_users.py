...
class FlattenedUsers(BaseModel):
    """
    A DAG-Safe collection of User references.
    """ # noqa: E501
    indices: Optional[Dict[str, StrictInt]] = Field(default=None, description="This is a Map<String, int> where the key is a user id.")
    iterable: List[ReferencedUser]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedUser.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedUsers.model_rebuild(raise_errors=False)
