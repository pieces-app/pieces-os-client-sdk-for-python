...
class OCRAnalysis(BaseModel):
    ...
    model: Model
    __properties: ClassVar[List[str]] = ["schema", "id", "raw", "hocr", "image", "model"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "raw": Format.from_dict(obj["raw"]) if obj.get("raw") is not None else None,
            "hocr": Format.from_dict(obj["hocr"]) if obj.get("hocr") is not None else None,
            "image": obj.get("image"),
...
OCRAnalysis.model_rebuild(raise_errors=False)
