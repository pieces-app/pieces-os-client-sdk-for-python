...
class OSDeviceInformationReturnable(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "dependencies", "name", "version", "hardware"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dependencies": OSDeviceDependenciesInformation.from_dict(obj["dependencies"]) if obj.get("dependencies") is not None else None,
            "name": obj.get("name"),
            "version": obj.get("version"),
            "hardware": OSDeviceHardwareInformation.from_dict(obj["hardware"]) if obj.get("hardware") is not None else None
        })
        return _obj
