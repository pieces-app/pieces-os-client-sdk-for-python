...
class SearchedPerson(BaseModel):
    ...
    """ # noqa: E501
    exact: StrictBool
    identifier: StrictStr = Field(description="This is the uuid of the person.")
    person: Optional[Person] = None
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    similarity: Union[StrictFloat, StrictInt]
    temporal: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["exact", "identifier", "person", "schema", "similarity", "temporal"]
