...
class FlattenedRanges(BaseModel):
    ...
    iterable: List[ReferencedRange]
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    score: Optional[Score] = None
    __properties: ClassVar[List[str]] = ["continuous", "indices", "iterable", "schema", "score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedRange.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedRanges.model_rebuild(raise_errors=False)
