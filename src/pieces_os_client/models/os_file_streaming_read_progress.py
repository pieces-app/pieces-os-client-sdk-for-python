...
class OSFileStreamingReadProgress(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "total", "transferred"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": ByteDescriptor.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "transferred": ByteDescriptor.from_dict(obj["transferred"]) if obj.get("transferred") is not None else None
        })
        return _obj
