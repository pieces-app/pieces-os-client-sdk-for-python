...
class WorkstreamEventsBatchFetchOutput(BaseModel):
    """
    ...
    workstream_events: WorkstreamEvents = Field(alias="workstreamEvents")
    __properties: ClassVar[List[str]] = ["notFound", "schema", "workstreamEvents"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.workstream_events:
            _dict['workstreamEvents'] = self.workstream_events.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workstreamEvents": WorkstreamEvents.from_dict(obj["workstreamEvents"]) if obj.get("workstreamEvents") is not None else None
        })
        return _obj
