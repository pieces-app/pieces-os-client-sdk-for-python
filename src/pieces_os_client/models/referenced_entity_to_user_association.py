...
class ReferencedEntityToUserAssociation(BaseModel):
    """
    ...
    reference: Optional[FlattenedEntityToUserAssociation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "reference": FlattenedEntityToUserAssociation.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
