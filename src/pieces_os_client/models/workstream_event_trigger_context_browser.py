...
class WorkstreamEventTriggerContextBrowser(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkstreamEventTriggerContextBrowser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkstreamEventTriggerContextBrowser:
        """Create an instance of WorkstreamEventTriggerContextBrowser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkstreamEventTriggerContextBrowser.parse_obj(obj)

        _obj = WorkstreamEventTriggerContextBrowser.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "tabs": BrowserTabs.from_dict(obj.get("tabs")) if obj.get("tabs") is not None else None
        })
        return _obj

from pieces_os_client.models.browser_tabs import BrowserTabs
WorkstreamEventTriggerContextBrowser.update_forward_refs()
