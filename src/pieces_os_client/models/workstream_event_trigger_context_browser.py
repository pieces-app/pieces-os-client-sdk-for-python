...
class WorkstreamEventTriggerContextBrowser(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "tabs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tabs": BrowserTabs.from_dict(obj["tabs"]) if obj.get("tabs") is not None else None
        })
        return _obj

from pieces_os_client.models.browser_tabs import BrowserTabs
# TODO: Rewrite to not use raise_errors
WorkstreamEventTriggerContextBrowser.model_rebuild(raise_errors=False)
