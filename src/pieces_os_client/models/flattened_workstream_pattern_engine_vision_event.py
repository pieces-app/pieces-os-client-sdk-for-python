...
class FlattenedWorkstreamPatternEngineVisionEvent(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FlattenedWorkstreamPatternEngineVisionEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FlattenedWorkstreamPatternEngineVisionEvent:
