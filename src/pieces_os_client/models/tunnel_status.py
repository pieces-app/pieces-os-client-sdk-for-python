...
class TunnelStatus(BaseModel):
    ...
    tunnels: List[TunnelInformation]
    version: Optional[StrictStr] = Field(default=None, description="NGrok client version")
    __properties: ClassVar[List[str]] = ["schema", "tunnels", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tunnels": [TunnelInformation.from_dict(_item) for _item in obj["tunnels"]] if obj.get("tunnels") is not None else None,
