...
class QGPTConversationPipeline(BaseModel):
    """
    This model is specifically for QGPT Conversation pipelines, the model is used to group conversational prompts for instance a conversation around generating code.  here are some use cases- 1. contextualized_code_generation- This is for users that want to have conversations around generating code, when there is provided context. 2. generalized_code- This is for users that want to have conversations without context around code. 3. contextualized_code- This is for users that want to have conversation around code with Context.  # noqa: E501
    """
    ...
    __properties = ["schema", "contextualized_code_generation", "generalized_code_dialog", "contextualized_code_dialog"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QGPTConversationPipeline:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QGPTConversationPipeline:
