...
class PersonType(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "basic", "platform"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "basic": PersonBasicType.from_dict(obj["basic"]) if obj.get("basic") is not None else None,
            "platform": UserProfile.from_dict(obj["platform"]) if obj.get("platform") is not None else None
        })
        return _obj
