...
class WorkstreamEventTrigger(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "check_in", "copy", "paste", "file_open", "file_close", "tab_switch", "tab_close", "tab_open", "tab_enter", "tab_leave", "url_changed", "application_enter", "application_leave", "application_switch", "native_screenshot"]
