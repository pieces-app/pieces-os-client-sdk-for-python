...
class WorkstreamEventTrigger(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["application_enter", "application_leave", "application_switch", "check_in", "copy", "file_close", "file_open", "native_screenshot", "paste", "schema", "tab_close", "tab_enter", "tab_leave", "tab_open", "tab_switch", "url_changed"]
