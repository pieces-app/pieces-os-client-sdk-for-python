...
class FlattenedEntities(BaseModel):
    """
    This is a DAG-Safe collection of Entity references.
    """ # noqa: E501
    indices: Optional[Dict[str, StrictInt]] = Field(default=None, description="This is a Map<String, int> where the key is an entity id.")
    iterable: List[ReferencedEntity]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedEntity.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedEntities.model_rebuild(raise_errors=False)
