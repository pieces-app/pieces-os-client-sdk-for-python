...
class FlattenedApplication(BaseModel):
    """
    Flattened version of the Application(for now just the same properties)  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FlattenedApplication:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FlattenedApplication:
        """Create an instance of FlattenedApplication from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FlattenedApplication.parse_obj(obj)

        _obj = FlattenedApplication.parse_obj({
