...
class DocumentContributors(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentContributors:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentContributors:
        """Create an instance of DocumentContributors from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentContributors.parse_obj(obj)

        _obj = DocumentContributors.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "iterable": [DocumentContributor.from_dict(_item) for _item in obj.get("iterable")] if obj.get("iterable") is not None else None
        })
        return _obj
