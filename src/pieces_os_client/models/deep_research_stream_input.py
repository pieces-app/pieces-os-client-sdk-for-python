...
class DeepResearchStreamInput(BaseModel):
    """
    ...
    reset: Optional[StrictBool] = Field(default=None, description="This will fully reset all current Activity within the Deep Research stream Flows.")
    stop: Optional[StrictBool] = Field(default=None, description="This will stop the output of the current LLM")
    __properties: ClassVar[List[str]] = ["conversation", "question", "relevance", "request", "reset", "stop"]
