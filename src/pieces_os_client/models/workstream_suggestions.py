...
class WorkstreamSuggestions(BaseModel):
    ...
    iterable: List[WorkstreamSuggestion]
    types: Optional[List[WorkstreamSuggestionType]] = Field(default=None, description="This is iterable <WorkstreamSuggestionType>[] that gives the type of each of the items in the iterable. I.E. types[0] is the suggestion type of the item at iterable[0].")
    __properties: ClassVar[List[str]] = ["schema", "iterable", "types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [WorkstreamSuggestion.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
            "types": [WorkstreamSuggestionType.from_dict(_item) for _item in obj["types"]] if obj.get("types") is not None else None
        })
        return _obj

from pieces_os_client.models.workstream_suggestion import WorkstreamSuggestion
# TODO: Rewrite to not use raise_errors
WorkstreamSuggestions.model_rebuild(raise_errors=False)
