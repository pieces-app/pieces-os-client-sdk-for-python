...
class BackupsStreamedProgress(BaseModel):
    ...
    """ # noqa: E501
    backups: Optional[List[BackupStreamedProgress]] = None
    restorations: Optional[List[BackupStreamedProgress]] = None
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    __properties: ClassVar[List[str]] = ["backups", "restorations", "schema"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.restorations:
            for _item_restorations in self.restorations:
                if _item_restorations:
                    _items.append(_item_restorations.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backups": [BackupStreamedProgress.from_dict(_item) for _item in obj["backups"]] if obj.get("backups") is not None else None,
            "restorations": [BackupStreamedProgress.from_dict(_item) for _item in obj["restorations"]] if obj.get("restorations") is not None else None,
