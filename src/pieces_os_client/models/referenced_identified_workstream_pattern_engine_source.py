...
class ReferencedIdentifiedWorkstreamPatternEngineSource(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "reference": FlattenedIdentifiedWorkstreamPatternEngineSource.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
...
ReferencedIdentifiedWorkstreamPatternEngineSource.model_rebuild(raise_errors=False)
