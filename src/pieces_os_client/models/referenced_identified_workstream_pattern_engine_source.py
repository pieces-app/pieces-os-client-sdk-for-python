...
class ReferencedIdentifiedWorkstreamPatternEngineSource(BaseModel):
    ...
    id: StrictStr = Field(...)
    reference: Optional[FlattenedIdentifiedWorkstreamPatternEngineSource] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferencedIdentifiedWorkstreamPatternEngineSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferencedIdentifiedWorkstreamPatternEngineSource:
        """Create an instance of ReferencedIdentifiedWorkstreamPatternEngineSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferencedIdentifiedWorkstreamPatternEngineSource.parse_obj(obj)

        _obj = ReferencedIdentifiedWorkstreamPatternEngineSource.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "id": obj.get("id"),
            "reference": FlattenedIdentifiedWorkstreamPatternEngineSource.from_dict(obj.get("reference")) if obj.get("reference") is not None else None
        })
        return _obj
