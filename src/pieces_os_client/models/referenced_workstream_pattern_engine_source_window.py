...
class ReferencedWorkstreamPatternEngineSourceWindow(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The id of the referenced source window")
    reference: Optional[FlattenedWorkstreamPatternEngineSourceWindow] = None
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    __properties: ClassVar[List[str]] = ["id", "reference", "schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "reference": FlattenedWorkstreamPatternEngineSourceWindow.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
...
ReferencedWorkstreamPatternEngineSourceWindow.model_rebuild(raise_errors=False)
