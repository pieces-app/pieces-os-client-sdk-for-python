...
class IdentifiedWorkstreamPatternEngineSource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessibility", "anchors", "conversations", "created", "filter", "id", "messages", "persons", "raw", "readable", "schema", "score", "summaries", "updated", "websites", "workstreamPatternEngineSourcesVector", "workstream_events"]
