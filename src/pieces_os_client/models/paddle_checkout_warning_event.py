...
class PaddleCheckoutWarningEvent(BaseModel):
    ...
    errors: Optional[List[PaddleCheckoutErrorDetail]] = None
    name: StrictStr
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    __properties: ClassVar[List[str]] = ["code", "detail", "documentation_url", "errors", "name", "schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [PaddleCheckoutErrorDetail.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "name": obj.get("name"),
