...
class PaddleCheckoutUpdatedEvent(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaddleCheckoutUpdatedEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaddleCheckoutUpdatedEvent:
        """Create an instance of PaddleCheckoutUpdatedEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaddleCheckoutUpdatedEvent.parse_obj(obj)

        _obj = PaddleCheckoutUpdatedEvent.parse_obj({
