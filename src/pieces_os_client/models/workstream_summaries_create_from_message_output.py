...
class WorkstreamSummariesCreateFromMessageOutput(BaseModel):
    """
    Output model for creating a workstream summary from a conversation message.
    """ # noqa: E501
    conversation_message: ReferencedConversationMessage
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    workstream_summary: ReferencedWorkstreamSummary
    __properties: ClassVar[List[str]] = ["conversation_message", "schema", "workstream_summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversation_message": ReferencedConversationMessage.from_dict(obj["conversation_message"]) if obj.get("conversation_message") is not None else None,
