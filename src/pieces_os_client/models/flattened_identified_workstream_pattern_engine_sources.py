...
class FlattenedIdentifiedWorkstreamPatternEngineSources(BaseModel):
    ...
    iterable: List[ReferencedIdentifiedWorkstreamPatternEngineSource]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedIdentifiedWorkstreamPatternEngineSource.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedIdentifiedWorkstreamPatternEngineSources.model_rebuild(raise_errors=False)
