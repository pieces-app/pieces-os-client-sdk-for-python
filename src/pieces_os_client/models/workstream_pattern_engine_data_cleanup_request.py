...
class WorkstreamPatternEngineDataCleanupRequest(BaseModel):
    ...
    """ # noqa: E501
    ranges: Optional[List[AnonymousTemporalRange]] = None
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    __properties: ClassVar[List[str]] = ["ranges", "schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ranges": [AnonymousTemporalRange.from_dict(_item) for _item in obj["ranges"]] if obj.get("ranges") is not None else None,
