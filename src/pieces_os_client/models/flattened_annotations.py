...
class FlattenedAnnotations(BaseModel):
    ...
    iterable: List[ReferencedAnnotation]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedAnnotation.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedAnnotations.model_rebuild(raise_errors=False)
