...
class FlattenedWorkstreamPatternEngineSourceWindows(BaseModel):
    ...
    iterable: List[ReferencedWorkstreamPatternEngineSourceWindow] = Field(description="This is the iterable of the flattened source windows")
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    score: Optional[Score] = None
    __properties: ClassVar[List[str]] = ["indices", "iterable", "schema", "score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedWorkstreamPatternEngineSourceWindow.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedWorkstreamPatternEngineSourceWindows.model_rebuild(raise_errors=False)
