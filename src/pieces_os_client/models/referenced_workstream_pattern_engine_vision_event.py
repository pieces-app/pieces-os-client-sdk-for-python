...
class ReferencedWorkstreamPatternEngineVisionEvent(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "reference": FlattenedWorkstreamPatternEngineVisionEvent.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
