...
class FlattenedConversationMessage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "id", "created", "updated", "deleted", "model", "fragment", "conversation", "sentiment", "role", "score", "annotations", "anchors", "persons", "websites"]
