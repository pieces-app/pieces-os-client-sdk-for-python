...
class WorkstreamSummaryAssociateWorkstreamSummaryInput(BaseModel):
    """
    ...
    """ # noqa: E501
    child: Optional[StrictStr] = Field(default=None, description="The UUID of the child workstream summary")
    parent: Optional[StrictStr] = Field(default=None, description="The UUID of the parent workstream summary")
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    __properties: ClassVar[List[str]] = ["child", "parent", "schema"]
