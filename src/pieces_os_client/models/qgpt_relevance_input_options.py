...
from pieces_os_client.models.workstream_summary_behavior_enum import WorkstreamSummaryBehaviorEnum
...
class QGPTRelevanceInputOptions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["behavior", "database", "pipeline", "question", "schema"]
