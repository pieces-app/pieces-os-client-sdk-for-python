...
class QGPTStreamedOutputExtractedMaterials(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "textual"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "textual": QGPTStreamedOutputExtractedTextualMaterials.from_dict(obj["textual"]) if obj.get("textual") is not None else None
        })
        return _obj
