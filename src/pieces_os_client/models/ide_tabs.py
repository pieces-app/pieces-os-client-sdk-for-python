...
class IDETabs(BaseModel):
    """
    This is a plural representation of a IDETab
    """ # noqa: E501
    iterable: List[IDETab]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iterable": [IDETab.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
IDETabs.model_rebuild(raise_errors=False)
