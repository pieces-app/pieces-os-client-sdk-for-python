...
class SearchedSensitive(BaseModel):
    """
    ...
    """ # noqa: E501
    exact: StrictBool
    identifier: StrictStr = Field(description="This is the uuid of the sensitive.")
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    sensitive: Optional[Sensitive] = None
    similarity: Union[StrictFloat, StrictInt]
    temporal: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["exact", "identifier", "schema", "sensitive", "similarity", "temporal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sensitive": Sensitive.from_dict(obj["sensitive"]) if obj.get("sensitive") is not None else None,
