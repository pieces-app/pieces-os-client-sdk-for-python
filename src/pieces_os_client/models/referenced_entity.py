...
class ReferencedEntity(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The UUID of the entity")
    reference: Optional[FlattenedEntity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "reference": FlattenedEntity.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
...
ReferencedEntity.model_rebuild(raise_errors=False)
