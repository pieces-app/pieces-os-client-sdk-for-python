...
class SeededScoreIncrement(BaseModel):
    ...
    __properties = ["anchor", "anchorPoint", "anchorPoints", "anchors", "annotation", "annotations", "asset", "assets", "conversation", "conversationMessage", "conversationMessages", "conversations", "hint", "hints", "person", "persons", "range", "ranges", "schema", "sensitive", "sensitives", "share", "shares", "tag", "tags", "website", "websites", "workstream_event", "workstream_events", "workstream_summaries", "workstream_summary"]
