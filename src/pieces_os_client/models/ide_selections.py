...
class IDESelections(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IDESelections:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IDESelections:
        """Create an instance of IDESelections from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IDESelections.parse_obj(obj)

        _obj = IDESelections.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "iterable": [IDESelection.from_dict(_item) for _item in obj.get("iterable")] if obj.get("iterable") is not None else None
        })
        return _obj
