...
class FlattenedPerson(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["access", "anchors", "annotations", "assets", "created", "deleted", "id", "interactions", "mechanisms", "messages", "models", "persons", "schema", "score", "sources", "summaries", "tags", "type", "updated", "websites", "workstream_events"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _field_dict = {}
        if self.access:
            for _key_access in self.access:
                if self.access[_key_access]:
                    _field_dict[_key_access] = self.access[_key_access].to_dict()
