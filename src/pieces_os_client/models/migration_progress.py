...
class MigrationProgress(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["batchSize", "currentBatch", "currentStage", "elapsedMilliseconds", "estimatedTimeRemaining", "percentComplete", "processedItems", "readable", "schema", "status", "totalItems"]
