...
class SearchedSubscriptions(BaseModel):
    ...
    """ # noqa: E501
    iterable: List[SearchedSubscription] = Field(description="This is the iterable of the searched subscriptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iterable": [SearchedSubscription.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
