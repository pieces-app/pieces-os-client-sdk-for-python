...
class ConversationsCreateFromWorkstreamSummaryOutput(BaseModel):
    """
    This is the model for the output for the \"/conversations/create/from_workstream_summary/{workstream_summary}\" endpoints.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationsCreateFromWorkstreamSummaryOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationsCreateFromWorkstreamSummaryOutput:
        """Create an instance of ConversationsCreateFromWorkstreamSummaryOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationsCreateFromWorkstreamSummaryOutput.parse_obj(obj)

        _obj = ConversationsCreateFromWorkstreamSummaryOutput.parse_obj({
