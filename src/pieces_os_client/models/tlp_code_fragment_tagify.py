...
class TLPCodeFragmentTagify(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TLPCodeFragmentTagify:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TLPCodeFragmentTagify:
        """Create an instance of TLPCodeFragmentTagify from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TLPCodeFragmentTagify.parse_obj(obj)

        _obj = TLPCodeFragmentTagify.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "code": TLPCodeSnippetTagifyCode.from_dict(obj.get("code")) if obj.get("code") is not None else None
        })
        return _obj
