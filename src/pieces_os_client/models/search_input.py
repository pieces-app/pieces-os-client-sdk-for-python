...
class SearchInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchInput:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic.v1 by calling `to_dict()` of engines
        if self.engines:
            _dict['engines'] = self.engines.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> SearchInput:
        """Create an instance of SearchInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchInput.parse_obj(obj)

        _obj = SearchInput.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "engines": SearchEngines.from_dict(obj.get("engines")) if obj.get("engines") is not None else None
        })
        return _obj
