...
class TemporalSearchOptions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "created", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "created": AnonymousTemporalRange.from_dict(obj["created"]) if obj.get("created") is not None else None,
            "updated": AnonymousTemporalRange.from_dict(obj["updated"]) if obj.get("updated") is not None else None
        })
        return _obj
