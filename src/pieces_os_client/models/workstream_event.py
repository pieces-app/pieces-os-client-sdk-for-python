...
class WorkstreamEvent(BaseModel):
    ...
    __properties = ["schema", "id", "score", "application", "created", "updated", "trigger", "context", "summaries", "tags", "readable", "workstreamEventsVector", "sources", "windowTitle", "browserUrl", "processing", "messages", "annotations", "anchors", "websites", "source_windows", "persons"]
