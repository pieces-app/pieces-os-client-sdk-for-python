...
class WorkstreamEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "id", "score", "application", "created", "updated", "trigger", "context", "summaries", "tags", "readable", "workstreamEventsVector", "sources", "windowTitle", "browserUrl", "processing"]
