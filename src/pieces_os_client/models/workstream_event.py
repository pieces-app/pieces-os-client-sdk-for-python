...
class WorkstreamEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["anchors", "annotations", "application", "browserUrl", "context", "created", "id", "messages", "persons", "processing", "readable", "schema", "score", "source_windows", "sources", "summaries", "tags", "trigger", "updated", "websites", "windowTitle", "workstreamEventsVector"]
