...
class SeededRangeConversationGroundingAssociation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "temporal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "temporal": SeededRangeConversationGroundingTemporalAssociation.from_dict(obj["temporal"]) if obj.get("temporal") is not None else None
        })
        return _obj
