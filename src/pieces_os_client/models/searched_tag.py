...
class SearchedTag(BaseModel):
    ...
    """ # noqa: E501
    exact: StrictBool
    identifier: StrictStr = Field(description="This is the uuid of the tag.")
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    similarity: Union[StrictFloat, StrictInt]
    tag: Optional[Tag] = None
    temporal: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["exact", "identifier", "schema", "similarity", "tag", "temporal"]
