...
class TrackedAssetEventCreationMetadataClipboard(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrackedAssetEventCreationMetadataClipboard:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrackedAssetEventCreationMetadataClipboard:
        """Create an instance of TrackedAssetEventCreationMetadataClipboard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrackedAssetEventCreationMetadataClipboard.parse_obj(obj)

        _obj = TrackedAssetEventCreationMetadataClipboard.parse_obj({
