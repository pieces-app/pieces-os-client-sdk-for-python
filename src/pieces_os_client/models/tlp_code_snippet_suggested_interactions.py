...
class TLPCodeSnippetSuggestedInteractions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TLPCodeSnippetSuggestedInteractions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TLPCodeSnippetSuggestedInteractions:
        """Create an instance of TLPCodeSnippetSuggestedInteractions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TLPCodeSnippetSuggestedInteractions.parse_obj(obj)

        _obj = TLPCodeSnippetSuggestedInteractions.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "save": TLPCodeFragmentSuggestedSave.from_dict(obj.get("save")) if obj.get("save") is not None else None,
            "reuse": TLPCodeFragmentSuggestedReuse.from_dict(obj.get("reuse")) if obj.get("reuse") is not None else None
        })
        return _obj
