...
class FlattenedAnchorPoints(BaseModel):
    ...
    iterable: List[ReferencedAnchorPoint]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedAnchorPoint.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedAnchorPoints.model_rebuild(raise_errors=False)
