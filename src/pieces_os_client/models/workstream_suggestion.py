...
class WorkstreamSuggestion(BaseModel):
    ...
    __properties = ["anchor", "anchors", "asset", "assets", "conversation", "conversations", "current", "person", "persons", "related", "schema", "seed", "seeds", "summaries", "summary", "tag", "tags", "website", "websites"]
