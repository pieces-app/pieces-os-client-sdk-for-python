...
class WorkstreamPatternEngineStatus(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkstreamPatternEngineStatus:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic.v1 by calling `to_dict()` of vision
        if self.vision:
            _dict['vision'] = self.vision.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> WorkstreamPatternEngineStatus:
        """Create an instance of WorkstreamPatternEngineStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkstreamPatternEngineStatus.parse_obj(obj)

        _obj = WorkstreamPatternEngineStatus.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "vision": WorkstreamPatternEngineVisionStatus.from_dict(obj.get("vision")) if obj.get("vision") is not None else None
        })
        return _obj
