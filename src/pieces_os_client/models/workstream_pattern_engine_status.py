...
class WorkstreamPatternEngineStatus(BaseModel):
    ...
    """ # noqa: E501
    clipboard: Optional[WorkstreamPatternEngineClipboardStatus] = None
    var_schema: Optional[EmbeddedModelSchema] = Field(default=None, alias="schema")
    vision: Optional[WorkstreamPatternEngineVisionStatus] = None
    __properties: ClassVar[List[str]] = ["clipboard", "schema", "vision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clipboard": WorkstreamPatternEngineClipboardStatus.from_dict(obj["clipboard"]) if obj.get("clipboard") is not None else None,
            "schema": EmbeddedModelSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
            "vision": WorkstreamPatternEngineVisionStatus.from_dict(obj["vision"]) if obj.get("vision") is not None else None
        })
        return _obj
