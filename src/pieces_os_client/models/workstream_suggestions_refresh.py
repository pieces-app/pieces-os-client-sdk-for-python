...
class WorkstreamSuggestionsRefresh(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "suggestions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "suggestions": WorkstreamSuggestions.from_dict(obj["suggestions"]) if obj.get("suggestions") is not None else None
        })
        return _obj
