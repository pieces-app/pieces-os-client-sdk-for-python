...
class OSPermissions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schema", "processing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processing": OSProcessingPermissions.from_dict(obj["processing"]) if obj.get("processing") is not None else None
        })
        return _obj
