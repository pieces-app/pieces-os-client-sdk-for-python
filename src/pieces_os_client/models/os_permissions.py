...
class OSPermissions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OSPermissions:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic.v1 by calling `to_dict()` of processing
        if self.processing:
            _dict['processing'] = self.processing.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> OSPermissions:
