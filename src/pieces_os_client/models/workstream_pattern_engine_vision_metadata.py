...
class WorkstreamPatternEngineVisionMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["events", "schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": WorkstreamPatternEngineVisionEventsMetadata.from_dict(obj["events"]) if obj.get("events") is not None else None,
