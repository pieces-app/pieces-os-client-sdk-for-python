...
class InstanceConfigurationAllowedModels(BaseModel):
    """
    A collection of allowed models for an entity configuration.
    """ # noqa: E501
    iterable: List[InstanceConfigurationAllowedModel]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iterable": [InstanceConfigurationAllowedModel.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
