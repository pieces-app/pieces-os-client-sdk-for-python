...
class FlattenedPersons(BaseModel):
    ...
    iterable: List[ReferencedPerson]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "iterable": [ReferencedPerson.from_dict(_item) for _item in obj["iterable"]] if obj.get("iterable") is not None else None,
...
FlattenedPersons.model_rebuild(raise_errors=False)
