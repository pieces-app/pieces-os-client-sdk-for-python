...
class Classifications(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Classifications:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Classifications:
        """Create an instance of Classifications from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Classifications.parse_obj(obj)

        _obj = Classifications.parse_obj({
