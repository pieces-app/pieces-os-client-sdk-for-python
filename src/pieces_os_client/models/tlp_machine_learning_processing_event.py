...
class TLPMachineLearningProcessingEvent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TLPMachineLearningProcessingEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TLPMachineLearningProcessingEvent:
        """Create an instance of TLPMachineLearningProcessingEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TLPMachineLearningProcessingEvent.parse_obj(obj)

        _obj = TLPMachineLearningProcessingEvent.parse_obj({
            "var_schema": EmbeddedModelSchema.from_dict(obj.get("schema")) if obj.get("schema") is not None else None,
            "code": TLPCodeProcessing.from_dict(obj.get("code")) if obj.get("code") is not None else None
        })
        return _obj
