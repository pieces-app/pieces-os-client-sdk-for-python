...
class NotificationsApi:
    ...
    def send_local_notification(
        ...
        _param = self._send_local_notification_serialize(
    ...
    @validate_call
    def send_local_notification_with_http_info(
        self,
        notification: Optional[Notification] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LocalNotificationResponse]:
        """/notifications/local/send [POST]
    ...
    @validate_call
    def send_local_notification_without_preload_content(
        self,
        notification: Optional[Notification] = None,
        _request_timeout: Union[
            None,
    ...
    def _send_local_notification_serialize(
        self,
        notification,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/notifications/local/send',
