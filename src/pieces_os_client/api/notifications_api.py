...
class NotificationsApi:
    ...
    def send_local_notification(self, notification : Optional[Notification] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.send_local_notification(notification, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the send_local_notification_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.send_local_notification_with_http_info(notification, **kwargs)  # noqa: E501
    ...
    def send_local_notification_with_http_info(self, notification : Optional[Notification] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.send_local_notification_with_http_info(notification, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method send_local_notification" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
