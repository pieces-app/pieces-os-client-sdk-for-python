...
class AnchorPointsApi:
    ...
    @validate_arguments
    def anchor_points_stream_identifiers(self, **kwargs) -> StreamedIdentifiers:  # noqa: E501
        """/anchor_points/stream/identifiers [WS]  # noqa: E501

        Provides a WebSocket connection that emits changes to your annotation identifiers (UUIDs).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.anchor_points_stream_identifiers(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the anchor_points_stream_identifiers_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.anchor_points_stream_identifiers_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def anchor_points_stream_identifiers_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """/anchor_points/stream/identifiers [WS]  # noqa: E501
        ...
        >>> thread = api.anchor_points_stream_identifiers_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method anchor_points_stream_identifiers" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/anchor_points/stream/identifiers', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
