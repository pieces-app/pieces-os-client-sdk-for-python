...
class RelationshipsApi:
    ...
    def relationships_snapshot(self, **kwargs) -> Relationships:  # noqa: E501
        ...
        >>> thread = api.relationships_snapshot(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the relationships_snapshot_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.relationships_snapshot_with_http_info(**kwargs)  # noqa: E501
    ...
    def relationships_snapshot_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.relationships_snapshot_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Relationships, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method relationships_snapshot" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
