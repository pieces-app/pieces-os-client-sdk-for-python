...
class RelationshipsApi:
    ...
    def relationships_snapshot(
        ...
        _param = self._relationships_snapshot_serialize(
    ...
    @validate_call
    def relationships_snapshot_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def relationships_snapshot_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _relationships_snapshot_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
