...
class CodeAnalysesApi:
    ...
    def code_analyses_snapshot(
        ...
        _param = self._code_analyses_snapshot_serialize(
    ...
    @validate_call
    def code_analyses_snapshot_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def code_analyses_snapshot_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _code_analyses_snapshot_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
