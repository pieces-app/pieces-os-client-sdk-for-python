...
class DeepResearchApi:
    ...
    def deep_research_stream(
        self,
        deep_research_stream_input: Optional[DeepResearchStreamInput] = None,
        ...
        :param deep_research_stream_input:
        :type deep_research_stream_input: DeepResearchStreamInput
        ...
        _param = self._deep_research_stream_serialize(
            deep_research_stream_input=deep_research_stream_input,
    ...
    @validate_call
    def deep_research_stream_with_http_info(
        self,
        deep_research_stream_input: Optional[DeepResearchStreamInput] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeepResearchStreamOutput]:
        """/deep_research/stream [WS]
    ...
    @validate_call
    def deep_research_stream_without_preload_content(
        self,
        deep_research_stream_input: Optional[DeepResearchStreamInput] = None,
        _request_timeout: Union[
            None,
    ...
    def _deep_research_stream_serialize(
        self,
        deep_research_stream_input,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if deep_research_stream_input is not None:
            _body_params = deep_research_stream_input
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/deep_research/stream',
