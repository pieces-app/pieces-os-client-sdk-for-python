...
class AnalysesApi:
    ...
    def analyses_snapshot(
        ...
        _param = self._analyses_snapshot_serialize(
    ...
    @validate_call
    def analyses_snapshot_with_http_info(
        self,
        transferables: Annotated[Optional[StrictBool], Field(description="This is a boolean that will decided if we are want to return the transferable data (default) or not(performance enhancement)")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def analyses_snapshot_without_preload_content(
        self,
        transferables: Annotated[Optional[StrictBool], Field(description="This is a boolean that will decided if we are want to return the transferable data (default) or not(performance enhancement)")] = None,
        _request_timeout: Union[
            None,
    ...
    def _analyses_snapshot_serialize(
        self,
        transferables,
        _request_auth,
        _content_type,
