...
class ApplicationsApi:
    ...
    def applications_external_related(self, **kwargs) -> DetectedExternalApplications:  # noqa: E501
        ...
        This will get the Applications that are currently installed on your Machine, that we have detected that we have an available Pieces integration for, however that you as a user have not installed yet. + applications that are installed where Pieces is going to be coming soon.  # noqa: E501
    ...
    def applications_external_snapshot(self, **kwargs) -> DetectedExternalApplications:  # noqa: E501
        ...
        This will get a snapshot of your installed applications on your local Machine. Applications like \"Microsoft Teams classic\", \"Google Chat\", \"Obsidian\", etc...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
