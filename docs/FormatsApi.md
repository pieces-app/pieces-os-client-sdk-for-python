...
[**formats_stream_identifiers**](FormatsApi.md#formats_stream_identifiers) | **GET** /formats/stream/identifiers | /formats/stream/identifiers [WS]
...
# **formats_stream_identifiers**
> StreamedIdentifiers formats_stream_identifiers()
...
with pieces_os_client.ApiClient(configuration) as api_client:
    ...
    try:
        # /formats/stream/identifiers [WS]
        api_response = api_instance.formats_stream_identifiers()
        print("The response of FormatsApi->formats_stream_identifiers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FormatsApi->formats_stream_identifiers: %s\n" % e)
```
