...
[**anchors_disassociate_asset**](AnchorsApi.md#anchors_disassociate_asset) | **POST** /anchors/{anchor}/assets/delete/{asset} | /anchors/{anchor}/assets/delete/{asset} [POST]
...
# **anchors_disassociate_asset**
> anchors_disassociate_asset(anchor, asset)
...
with pieces_os_client.ApiClient(configuration) as api_client:
    ...
    try:
        # /anchors/{anchor}/assets/delete/{asset} [POST]
        api_instance.anchors_disassociate_asset(anchor, asset)
    except Exception as e:
        print("Exception when calling AnchorsApi->anchors_disassociate_asset: %s\n" % e)
```
