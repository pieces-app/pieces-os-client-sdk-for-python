...
* `HLJS_MINUS_ERLANG` (value: `'hljs-erlang'`)
...
* `HLJS_MINUS_JULIA` (value: `'hljs-julia'`)
...
* `HLJS_MINUS_PARSER3` (value: `'hljs-parser3'`)
...
* `HLJS_MINUS_SMALI` (value: `'hljs-smali'`)
...
* `HLJS_MINUS_HTML` (value: `'hljs-html'`)
